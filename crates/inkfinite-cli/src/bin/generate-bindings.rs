...
fn model_bindings() -> String {
    ...
    append_declaration::<GradientUnits>(&mut output, &config);
    append_declaration::<GradientSpread>(&mut output, &config);
    append_declaration::<GradientTransform>(&mut output, &config);
