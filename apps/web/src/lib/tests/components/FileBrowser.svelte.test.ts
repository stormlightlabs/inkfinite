...
import { FileBrowserVM, type FileBrowserViewModel } from '$editor/filebrowser/model';
...
function createMockBoards(): BoardMeta[] {
	return [
		{ id: 'board-1', name: 'Board 1', createdAt: 1000, updatedAt: 2000 },
		{ id: 'board-2', name: 'Board 2', createdAt: 1500, updatedAt: 2500 },
