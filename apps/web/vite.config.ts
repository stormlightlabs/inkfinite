	...
	resolve: {
		alias: {
			...
			'@inkfinite/core': new URL('../../packages/core/src/index.ts', import.meta.url)
				.pathname,
			'@inkfinite/input-dom': new URL(
				'../../packages/input-dom/src/index.ts',
				import.meta.url
			).pathname,
			'@inkfinite/renderer': new URL('../../packages/renderer/src/index.ts', import.meta.url)
				.pathname,
			'@inkfinite/runtime': new URL('../../packages/runtime/src/index.ts', import.meta.url)
				.pathname,
