...
describe('Store', () => {
  ...
  describe('setState', () => {
    ...
    it('should update camera position', () => {
      ...
      store.setState((state) => ({
        ...state,
        camera: Camera.pan(state.camera, { x: 50, y: 30 }),
      }));
...
describe('Invariants', () => {
  ...
  describe('selectionIds invariant', () => {
    ...
    it('should remove non-existent shapes from selection', () => {
      ...
      store.setState((state) => ({
        ...
        ui: {
          ...state.ui,
          currentPageId: 'page1',
          selectionIds: ['shape1', 'nonexistent', 'shape2'],
        },
      }));
    ...
    it('should maintain reference equality when no repair needed', () => {
      ...
      store.setState((state) => ({
        ...state,
        camera: { ...state.camera, x: 100 },
      }));

      const stateAfter = store.getState();

      // UI should maintain reference equality if not repaired
  ...
  describe('getSelectedShapes', () => {
    ...
    it('should return selected shapes', () => {
      ...
      const shape3 = ShapeRecord.createLine(
        ...
        100,
        100,
        { a: { x: 0, y: 0 }, b: { x: 100, y: 0 }, stroke: '#000', width: 2 },
        'shape3',
      );
...
describe('Integration scenarios', () => {
  ...
  it('should handle camera operations while maintaining state', () => {
    ...
    store.setState((state) => ({
      ...state,
      camera: Camera.pan(state.camera, { x: 100, y: 50 }),
    }));
