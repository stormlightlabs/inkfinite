...
import { CursorState as CursorStateOps, EditorShapeRecord, EditorState } from '@inkfinite/core';
import type { EditorShapeRecord as ShapeRecordType } from '@inkfinite/core';
import {
	buildStatusBarVM,
	getSelectionSummary,
	getSnapSummary,
	...
	describe('getToolId', () => {
		it('returns the active tool id', () => {
			...
			const state: EditorState = {
				...base,
				ui: { ...base.ui, toolId: 'rect', currentPageId: null, selectionIds: [] }
			};
